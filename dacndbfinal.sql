...
--
-- Host: localhost
-- Generation Time: Dec 27, 2021 at 02:37 AM
...
('KH05', 'Lê Thị Ba', '271 Tùng Thiện Vương, Phường 11, Quận 8', 23122142, '123456');
...
INSERT INTO `sanpham` (`MSSP`, `TenSP`, `IMG`, `MSNSX`, `Gia`, `MSLSP`, `TSSP`, `MSTTSP`) VALUES
('37DV', 'Laptop Acer Aspire 3 A315 56 37DV', '', 'ACER', 11190000, 'LGM', 'Intel Core i3-1005G1 1.2GHz up to 3.4GHz 4MB', 0),
('502X', 'Laptop Acer Aspire 3 A315 56 502X', 'Screen Shot 2021-12-14 at 05.50.04.png', 'ACER', 12790000, 'LGM', '4GB DDR4 2666MHz Onboard (1x SO-DIMM socket, up to 12GB SDRAM)', 1),
('5S11130SB', 'Laptop GIGABYTE G5 KC 5S11130SB', 'Screen Shot 2021-12-14 at 05.50.04.png', 'GGB', 27990000, 'LGM', '16GB (2x8GB) DDR4-3200Mhz (2 khe ram, nâng cấp tối đa 64GB RAM)', 1),
('73S1224GH', 'Laptop GIGABYTE AORUS 15P YD 73S1224GH', 'Screen Shot 2021-12-14 at 05.50.04.png', 'GGB', 72490000, 'LGM', '16GB (2x8GB) DDR4-3200Mhz (2x khe ram nâng cấp tối đa 64GB RAM)', 1),
('73S1324GH', 'Laptop GIGABYTE AORUS 15P XD 73S1324GH', 'Screen Shot 2021-12-14 at 05.50.04.png', 'GGB', 51990000, 'LGM', '16GB (2x8GB) DDR4-3200Mhz (2x khe ram nâng cấp tối đa 64GB RAM)', 1),
('75YD', 'Laptop Gaming Acer Predator Helios 300 PH315 54 75YD', 'Screen Shot 2021-12-14 at 05.50.04.png', 'ACER', 39990000, 'LGM', '16GB (8x2) DDR4 3200MHz (2x SO-DIMM socket, up to 32GB SDRAM)', 1),
...
('BQ1006T', 'Laptop ASUS Vivobook X515EA BQ1006T', '', 'ASUS', 13190000, 'LVP', '4GB Onboard ,DDR4 2666MHz up to 12GB SDRAM', 0),
('EC227T', 'Laptop Asus VivoBook Flip TM420IA EC227T', '', 'ASUS', 19490000, 'LVP', '8GB DDR4 3200MHz On Board', 1),
('EJ1046T', 'Laptop ASUS X515EA EJ1046T AWC72', '', 'ASUS', 16590000, 'LVP', '4GB Onboard + 4GB SO-DIMM socket DDR4 2666MHz up to 12GB SDRAM', 0),
('EK675W', 'Laptop Asus X415EA EK675W', '', 'ASUS', 12690000, 'LGM', '4GB DDR4 on board, 1x DDR4 SO-DIMM slot', 1),
('H510M H', 'GIGABYTE H510M H (rev. 1.0)', '', 'GGB', 1990000, 'PKGM', 'LGA1200 package:\r\n1. 11th Generation Intel® Core™ i9 processors / Intel® Core™ i7 processors / Intel® Core™ i5 processors\r\n2. 10th Generation Intel® Core™ i9 processors / Intel® Core™ i7 processors / Intel® Core™ i5 processors / Intel® Core™ i3 processors/ Intel® Pentium® processors / Intel® Celeron® processors* (* Limited to processors with 4 MB Intel® Smart Cache, Intel® Celeron® G5xx5 family)\r\n3. L3 cache varies with CPU', 1),
('H510M-A', 'MSI H510M-A PRO', '', 'MSI', 2050000, 'PKGM', 'Supports 10th Gen Intel® Core™ Processors, 11th Gen Intel® Core™ Processors, Pentium® Gold and Celeron® Processors', 1),
('HN015T', 'Laptop Gaming Asus ROG Strix G15 G513IH HN015T', '', 'ASUS', 23290000, 'LGM', '8GB DDR4 3200MHz (2x SO-DIMM socket)', 1),
('KI429T', 'Laptop ASUS ZenBook UX425EA KI429T', '', 'ASUS', 21790000, 'LGM', '	8GB 4266MHz LPDDR4X, 	512GB PCIe® NVMe™ 3.0 x2 M.2 SSD', 1),
('KM040T', 'Laptop Asus Vivobook Pro M3401QA KM040T', '', 'ASUS', 22990000, 'LGM', '8GB (Onboard) DDR4 3200MHz (không nâng cấp)', 1),
('M15R6 ', 'Laptop Gaming Dell Alienware M15 R6 P109F001BBL', '', 'DELL', 57990000, 'LGM', '32GB (2x16GB) DDR4 3200Mhz (2 khe, max 64GB RAM)', 1),
('MBZ590', 'GIGABYTE Z590 GAMING X (rev. 1.0)\r\n', '', 'GGB', 5190000, 'PKGM', 'Ram hỗ trợ : 5333(O.C.) / DDR4 5133(O.C.) / DDR4 5000 (O.C.) / 4933(O.C.) / 4800(O.C.) / 4700(O.C.) / 4600(O.C.) / 4500(O.C.) / 4400(O.C.) / 4300(O.C.) / 4266(O.C.) / 4133(O) .C.) / 4000(O.C.) / 3866(O.C.) / 3800(O.C.) / 3733(O.C.) / 3666(O.C.) / 3600(O.C.) / 3466(O.C.) / 3400(O.C.) / 3333(O.C.) / 3400(O.C.) / 3333(O.C.) .C)/ 3300(O.C.) / 3200 / 3000 / 2933 / 2800 / 2666 / 2400 / 2133 MHz\r\n\r\nLưu trữ : 	\r\n1 x M.2 NVMe, 2 x M.2 SATA/NVMe, 6 x SATA 6Gb/s', 1),
('MSIB15', 'Laptop Gaming MSI Bravo 15 B5DD 276VN\r\n', '', 'MSI', 20790000, 'LGM', 'AMD Ryzen 5-5600H 3.30GHz upto 4.20GHz, 6 cores 12 threads\r\nDDR4 8GB (1 x 8GB) 3200MHz; 2 slots, Up to 64GB\r\n512GB NVMe PCIe Gen3x4 SSD\r\nRadeon RX5500M 4GB\r\n15.6 inch FHD (1920*1080), 60Hz 45%NTSC IPS-Level', 1),
('R05G', 'Laptop Gaming Acer Aspire 7 A715 42G R05G', '', 'ACER', 20390000, 'LGM', '8GB DDR4 (2x SO-DIMM socket, up to 32GB SDRAM)', 1),
('R9SC', 'Laptop gaming Acer Nitro 5 AN515 45 R9SC', '', 'ACER', 36990000, 'LGM', '8GB DDR4 3200MHz (2x SO-DIMM socket, up to 32GB SDRAM)', 1),
('SPTEST1', 'San pham test', '', 'DELL', 120000, 'LVP', 'đâsad', 1),
('SPTEST4', 'San pham test', 'Screen Shot 2021-12-14 at 09.53.24.png', 'ACER', 1111, 'LVP', 'sssss', 1),
('SPTEST5', 'Laptop Gaming Asus ROG Strix G15 G513IH HN015T123', 'Screen Shot 2021-12-14 at 09.53.24.png', 'ACER', 1111, 'LGM', '1111', 1);
...
--
-- Table structure for table `trangthaisanpham`
--

CREATE TABLE `trangthaisanpham` (
  `MSTTSP` tinyint(2) NOT NULL DEFAULT 1,
  `TenTTSP` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `trangthaisanpham`
--

INSERT INTO `trangthaisanpham` (`MSTTSP`, `TenTTSP`) VALUES
(0, 'Hết hàng'),
(1, 'Còn hàng');
...
ALTER TABLE `sanpham`
  ...
  ADD KEY `sanpham_trangthaiSP_msttsp_fk3` (`MSTTSP`);
...
--
-- Indexes for table `trangthaisanpham`
--
ALTER TABLE `trangthaisanpham`
  ADD PRIMARY KEY (`MSTTSP`);
...
ALTER TABLE `sanpham`
  ...
  ADD CONSTRAINT `sanpham_trangthaiSP_msttsp_fk3` FOREIGN KEY (`MSTTSP`) REFERENCES `trangthaisanpham` (`MSTTSP`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
