                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" style="min-width: 800px;" name="MSKH" value='<?php echo $data1->MSKH ?>' readonly></td>

                                    </tr>
                                    <tr>
                                        <td scope="row">Tên khách hàng :</td>
                                        <td><input type="text" name="TenKH" style="min-width: 800px;" value='<?php echo $data1->TenKH ?>'></td>

                                    </tr>
                                    <tr>
                                        <td scope="row"> Địa chỉ :</td>
                                        <td><input type="text" style="min-width: 800px;" name="DiaChi" value='<?php echo $data1->DiaChi ?>'></td>
