                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="text" style="min-width: 800px;" name="MSSP" value='<?php echo $data1->MSSP ?>' readonly></td>

                                    </tr>
                                    <tr>
                                        <td scope="row">Tên sản phẩm :</td>
                                        <td><input type="text" name="TenSP" style="min-width: 800px;" value='<?php echo $data1->TenSP ?>'></td>

                                    </tr>
                                    <tr>
                                        <td>Hình ảnh </td>
                                        <td><input type="file" name="img" value='<?php echo $data1->IMG ?>'></td>
                                    </tr>
                                    <tr>
                                        <td>Giá : </td>
                                        <td><input type="number" name="Gia" value='<?php echo $data1->Gia ?>'></td>
                                    </tr>

                                    <tr>
                                        <td>Thông số sản phẩm :</td>
                                        <td><textarea name="thongso" id="" cols="80" rows="10"><?php echo $data1->TSSP ?></textarea> </td>
                                    </tr>
                                    <tr>
                                        <td>Nhà sản xuất</td>
                                        <td>
