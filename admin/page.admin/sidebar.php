<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Administration</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="loaiSanPham.php">Danh sách loại sản phẩm</a>
                        <a class="collapse-item" href="addSanPham.php">Thêm sản phẩm mới</a>
                        <a class="collapse-item" href="addLoaiSP.php">Thêm loại sản phẩm mới</a>
                        <h6 class="collapse-header">Nhà sản xuất:</h6>
                        <a class="collapse-item" href="nhaSanXuat.php">Danh sách nhà sản xuất</a>
                        <a class="collapse-item" href="addNSX.php">Thêm nhà sản xuất mới</a>     
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="khachHang.php">Danh sách các khách hàng</a>                    </div>
                </div>
            </li>
