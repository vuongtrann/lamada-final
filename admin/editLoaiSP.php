...
$sql = "select * from LOAISANPHAM where MSLSP= ? ";
$a = [$m];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="updateLoaiSP.php" method="post" enctype="multipart/form-data">
                            <table class="table">

                                <tbody>
                                    <tr>
                                        <td scope="row"> Mã số loại sản phẩm :</td>
                                        <td><input type="text" style="min-width: 800px;" name="MSLSP" value='<?php echo $data1->MSLSP ?>' readonly></td>

                                    </tr>
                                    <tr>
                                        <td scope="row">Tên loại sản phẩm :</td>
                                        <td><input type="text" name="TenLoai" style="min-width: 800px;" value='<?php echo $data1->TenLoai ?>'></td>
