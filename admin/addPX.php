        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="savePX.php" method="post" enctype="multipart/form-data">
                            <table class="table">

                                <tbody>
                                    <tr>
                                        <td scope="row"> Mã số phiếu xuất :</td>
                                        <td><input type="text" style="min-width: 800px;" name="MSPX" ></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="date" name="NgayXuat" style="min-width: 800px;" ></td>
                            ...
                            <input type="submit" style="min-width: 100px; " value="Thêm phiếu xuất">
