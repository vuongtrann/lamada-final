...
$sql = "select * from NHASANXUAT where MSNSX= ? ";
$a = [$m];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="updateNSX.php" method="post" enctype="multipart/form-data">
                            <table class="table">

                                <tbody>
                                    <tr>
                                        <td scope="row"> Mã số nhà sản xuất :</td>
                                        <td><input type="text" style="min-width: 800px;" name="MSNSX" value='<?php echo $data1->MSNSX ?>' readonly></td>

                                    </tr>
                                    <tr>
                                        <td scope="row">Tên nhà sản xuất :</td>
                                        <td><input type="text" name="TenNSX" style="min-width: 800px;" value='<?php echo $data1->TenNSX ?>'></td>

                                    </tr>
                                    <tr>
                                        <td scope="row"> Xuất sứ :</td>
                                        <td><input type="text" style="min-width: 800px;" name="XuatSu" value='<?php echo $data1->XuatSu ?>'></td>
